...
class ExcelCSV
  class << self
    ...
    def read(filename, options = {}, &block)
      ...
      file = File.open(
        filename, external_encoding: encoding, internal_encoding: 'UTF-8'
      )
    ...
    # rather than UTF-8. Importing UTF-8 is possible, but only in Excel 2013,
    # and has problems with line endings.
